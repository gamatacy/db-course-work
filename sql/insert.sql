...
INSERT INTO client_jn (name, password, registration_date)
VALUES ('John Doe', 'lool', '2023-01-01'),
       ('Jane Smith', 'lool', '2023-02-15'),
       ('Bob Johnson', 'lool', '2023-03-20');
...
VALUES (2, 4, 'Great service!', '2023-01-05'),
       (3, 5, 'Love their coffee!', '2023-02-18'),
       (4, 3, 'Could improve the variety.', '2023-03-25');
...
VALUES (2, '789 Elm St', '2023-04-01', 25.50, 1),
       (3, '101 Maple Ave', '2023-04-02', 18.75, 2),
       (4, '555 Birch Blvd', '2023-04-03', 30.20, 3);

-- Insert data into milk_ref
INSERT INTO milk_ref (name, price)
VALUES ('Whole Milk', 2.50),
       ('Almond Milk', 3.00),
       ('Soy Milk', 2.75);
...
INSERT INTO coffee_size_ref (name, price)
VALUES ('Small', 12),
       ('Medium', 16),
       ('Large', 20);
...
UPDATE client_jn
SET favourite_shop   = 1,
    favourite_coffee = 1
WHERE id = 1;

UPDATE client_jn
SET favourite_shop   = 2,
    favourite_coffee = 2
WHERE id = 2;

UPDATE client_jn
SET favourite_shop   = 3,
    favourite_coffee = 3
WHERE id = 3;
